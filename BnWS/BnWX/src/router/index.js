...
const router = new Router({
  routes: [
    ...
    ,{ path: '/FavoriteList', name: 'FavoriteList', component: (resolve) => require(['@/components/FavoriteList.vue'], resolve),meta: { allowAnonymous: true, showTabbar:true,title:'收藏',componentName:'我的'}}
