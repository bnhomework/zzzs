        ...
        protected override void Render(ISvgRenderer renderer)
        {
            ...
            if (Width.Value > 0.0f && Height.Value > 0.0f && this.Href != null)
            {
                ...
                if (img != null)
                {
                    ...
                    if (AspectRatio == null)
                    {
                        if (srcRect.Height > srcRect.Width)
                        {
                            AspectRatio = new SvgAspectRatio(SvgPreserveAspectRatio.xMidYMax);
                        }
                        else
                        {
                            AspectRatio = new SvgAspectRatio(SvgPreserveAspectRatio.xMaxYMid);
                        }
                    }
